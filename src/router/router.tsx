...
const routes = (user: IUser) => [
  ...
  ...createRoutesFromElements(
    <>
      <Route id="home" path={ROUTE.HOME} element={<MainLayout />}>
        <Route id="home-layout" index element={<HomePage />} />
        <Route id="platfoms" path={ROUTE.PLATFORMS} element={<PlatformsPage />} />
        <Route id="protect-auth" element={<ProtectedAuth user={user} />}>
          <Route id="profile-layout" path={ROUTE.PROFILE} element={<ProfileLayout />}>
            ...
            <Route id="profile-history" path={ROUTE.PROFILE_HISTORY} element={<ProfileHistoryPage />} />
            <Route id="profile-settings" path={ROUTE.PROFILE_SETTINGS} element={<ProfileSettingsPage />} />
          </Route>
        </Route>

        <Route id="platfoms-details" path={ROUTE.PLATFORMS_DETAILS} element={<PlatformDetailsPage />}>
